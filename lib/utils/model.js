...
export default class Model {
  ...
  extractModel (fields, model, parentModel, originModel) {
    ...
    fields.forEach((field) => {
      ...
      const mapMapping = () => field.mapping({ model, key: field.key, newModel, parentModel, originModel, store: this.$store, localePath: this.localePath, i18n: this.$t, $tc: this.$tc, $t: this.$t, ctx: this.ctx })
